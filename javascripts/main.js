const pages = [
  ...
  },
  {
    ...
    images: [
      ,
      //кадры из другой эпохи
      {
        image: 'images/50s/film-1.png',
  ...
  },
  {
    ...
    books: {
      book1: {
        ...
        name: '«Страна багровых туч»',
        cite: 'Вообще назначение человека, — добавил он подумав, — превращать любое место, куда ступит его нога, в цветущий сад.'
      },
      book2: {
        author: 'Александр Солженицын',
        name: '«Один день Ивана Денисовича»',
        cite: 'Работа – она как палка, конца в ней два: для людей делаешь – качество дай, для начальника делаешь – дай показуху.'
      }
    },
    films: [
      {
